...
def main():
    ...
    with requests.Session() as public:
        ...
        # Independently verify the public result; never label a queued build published.
        for _ in range(30):
            time.sleep(10)
            if published(public, expected):
                print("Publicación verificada: JSON e imágenes disponibles en mikostudios.co.")
                return
